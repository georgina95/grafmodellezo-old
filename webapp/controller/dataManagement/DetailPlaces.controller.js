sap.ui.define([
	...
	return DetailBaseController.extend("elte.Grafmodellezo.controller.dataManagement.DetailPlaces", {
		
		onInit: function () {
			var oModel = new JSONModel({ });
			this.getView().setModel(oModel, "Object");
			
			this.setRouteMatched("DetailPlaces", this.onRouteMatched);
		},
		...
		onRouteMatched: function(oEvent) {
			...
			this.readObject("places", oId, oParameters);
		}
